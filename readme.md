...
3. [How to generate ssh key（如何生成ssh密钥）?](https://github.com/niudong1001/toolkits/issues/6)
4. [How to transfer file between two hosts by using the SCP command（如何使用SCP命令在两台主机间传输文件）?](https://github.com/niudong1001/toolkits/issues/7)
